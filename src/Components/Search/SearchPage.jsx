  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Find what you're looking for quickly and easily on Mr.Mad's search page. Enter the product name or keywords to discover a wide range of options tailored to your preferences."
        />
      </Helmet>
