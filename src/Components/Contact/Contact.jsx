  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Get in touch with Mr.Mad's customer support team for assistance with your orders, inquiries, or feedback. We're here to help you with any questions you may have."
        />
      </Helmet>
